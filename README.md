CWL is a front end web language implemented with Rust procedural macros. Code compiled from CWL runs in a browser, and consists of an HTML component and a Webassembly binary.
